...
<html lang="en">
    <head>
		...
		<title>About Page ! Tweek Bros</title>
    ...
    <body>
		...
		<div class="headeriner">
			...
			<div class="aboutusdiv row-pd abtus">
				<div class="container">
				<div class="row puretext section p3" id="p3">
			...
			<div class="goals row-pd gallery-page">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-8">
							<h2>Certificates or Achievements </h2>
							<div class="item"> 
								<a href="#" class="photo">
									<img src="img/abt.jpg">
								</a>
								<div class="descr">
									<div class="row">
										<div class="col-lg-12">
											<h4 class="header">Coffee &amp; performance</h4></div>
										</div>
								</div>
							</div>
							<div class="item"> 
						...
						<div class="col-md-4">
							<h2>Goals</h2>
							<p>
							Tweek Bros. Coffee has been running in Australia for two years and now they plan to expand their business and client base, expand revenue and aim to get enough exposure to then be able franchise their own cafes whilst wholesaling coffee beans and other coffee related products.
							</p>
						</div>
					</div>	
				</div>
